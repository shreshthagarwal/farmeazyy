      ...
      <div className="pricepredictor-content-container">
        <div className="pricepredictor-image">
          ...
          <a href="http://127.0.0.1:5000/" target="_blank" rel="noopener noreferrer">
            <button className="predictor-button">
              Predict Now
        ...
        <div className="pricepredictor-textbox">
          <div className="pricepredictor-content">
            ...
            <p>At FarmEazyy, our advanced Price Prediction Model harnesses machine learning to provide accurate forecasts of crop prices.</p> 
            <p>By analyzing historical data, weather conditions, and market trends, our model delivers real-time price predictions that enable farmers to make well-informed decisions.</p>
            <p>This insight helps farmers optimize planting and harvesting schedules, maximize their profits, and manage risks associated with price fluctuations.</p>
            <p>With our model, farmers gain valuable knowledge of future market conditions, allowing them to strategically sell their produce and efficiently allocate resources, ensuring greater financial stability and growth.</p>
          </div>
        </div>
